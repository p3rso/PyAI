...
while(Fin != "yes"):
    roundsa = roundsa+1
    if mode == "BYTE":
        while(roundsc <= (InputAmount/8)-1):  #mess with these while loops if you are looking for program input not user input.
...
print("the AI went thru %s stages of practice" % roundsa)
